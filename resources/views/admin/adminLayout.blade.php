...
<head>
    ...
    <title>PUP Care Portal - @yield('title', 'Admin Dashboard')</title>
...
<body>
    ...
    <div class="d-flex" style="height: 100vh; overflow: hidden;">
        ...
        <aside class="bg-white border-end p-4 d-flex flex-column justify-content-between h-100" style="width: 260px; flex-shrink: 0;">
            ...
            <div>
                <form action="{{ route('logout') }}" method="POST">
                    @csrf
                    <button type="submit" class="nav-link border-0 w-100 text-start bg-transparent nav-link-logout px-3 py-2.5">
        ...
        <div class="flex-grow-1 d-flex flex-column h-100" style="overflow: hidden;">
            <header class="bg-white border-bottom px-4 d-flex align-items-center justify-content-end" style="height: 80px; flex-shrink: 0;">
                <div class="d-flex align-items-center gap-3">
                    <div class="text-end">
                        <p class="mb-0 fw-bold text-dark small">Admin 1</p>
                        <p class="mb-0 text-muted small" style="font-size: 11px;">Administrator</p>
                    </div>
