...
Route::group(['prefix' => '/'], function () {
    ...
    Route::get('/register/email/verify', [AuthController::class, 'showVerifyEmail'])
        ->middleware('auth')
        ->name('verification.notice');

    Route::get('/register/email/verify/{id}/{hash}', [AuthController::class, 'verifyEmail'])
        ->middleware(['auth', 'signed'])
        ->name('verification.verify');

    Route::post('/register/email/resend', [AuthController::class, 'resendVerification'])
