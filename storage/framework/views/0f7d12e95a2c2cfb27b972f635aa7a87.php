...
<head>
    ...
    <title>PUP Care - My Medical Records</title>
        ...
        <aside class="bg-white border-end p-4 d-flex flex-column justify-content-between h-100 flex-shrink-0" style="width: 256px;">
            <div>
                ...
                <nav class="d-flex flex-column gap-1">
                    ...
                    <a href="/patient/<?php echo e($patient_id); ?>/records" class="d-flex align-items-center gap-2 text-decoration-none px-3 py-2 rounded text-primary bg-primary bg-opacity-10 fw-semibold transition-all">
                        ...
                        <div class="hospital-card d-flex flex-column h-100" style="min-height: 300px;">
                            ...
                            <nav class="navbar bg-transparent mb-3">
                                <div class="container-fluid">
                                    <form method = "GET" action = "<?php echo e(route('searchRecord', ['patient' => $patient_id ])); ?>" class="d-flex" role="search">
                                    <div class="input-group me-2" style="max-width: 100%;">
                                        <span class="input-group-text">
                                            <i class="bi bi-search"></i>
                                        </span>
                                        <input class="form-control me-2" type="search"  aria-label="Search" name = "param" value = "<?php echo e(request('param')); ?>" placeholder="Enter keyword">
                                    </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-borderless align-middle mb-0">
                                        ...
                                        <tbody class="text-dark fw-medium" style="font-size: 14px;">
                                            <?php $__currentLoopData = $medrecord; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr class="border-bottom">
                                                <td class="text-nowrap"><?php echo e($row->Date); ?></td>
                                                <td class="text-nowrap"><?php echo e($row->Type); ?></td>
                                                <td class="text-nowrap"><?php echo e($row->Doctor); ?></td>
...
</style><?php /**PATH C:\Users\HP\Documents\Visual Studio Projects\webdev_patient\resources\views/patient/records.blade.php ENDPATH**/ ?>