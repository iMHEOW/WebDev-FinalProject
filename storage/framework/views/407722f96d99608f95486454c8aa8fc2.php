    ...
    <div class="d-flex vh-100 overflow-hidden">
        ...
        <aside class="bg-white border-end p-4 d-flex flex-column justify-content-between h-100 flex-shrink-0" style="width: 256px;">
            <div>
                ...
                <nav class="d-flex flex-column gap-1">
                    <a href="/patient/<?php echo e($patient_id); ?>/dashboard" class="d-flex align-items-center gap-2 text-decoration-none px-3 py-2 rounded text-primary bg-primary bg-opacity-10 fw-semibold transition-all">
        ...
        <div class="flex-grow-1 d-flex flex-column h-100 overflow-hidden">
            ...
            <?php endif; ?>
                ...
                <h2><b>Welcome back</b>, <?php echo e($patientName); ?>!</h2>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-borderless align-middle mb-5">
                                        ...
                                        <tbody class="text-dark fw-medium" style="font-size: 14px;">
                                            <?php $__currentLoopData = $dboardUp; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr class="border-bottom text-center">
                                                <td><?php echo e($row->Date); ?></td>
                                                <td><?php echo e($row->Time); ?></td>
                                                <td><?php echo e($row->Modality); ?></td>
                                                <td><?php echo e($row->Doctor); ?></td>
                                                <td><?php echo e($row->Department); ?></td>
                                                <td>
                                                    <span class="<?php echo e($row->Status == 'Cancelled' ? 'text-danger fw-bold' : ''); ?>">
                                                ...
                                                <td>
                                                    <?php if($row->Status !== 'Cancelled'): ?>
                                                        <form action="<?php echo e(route('patient.cancelAppointment', ['patient' => $patient_id])); ?>" method="POST" onsubmit="return confirm('Are you sure you want to cancel this appointment? This action cannot be undone.');">
                                                            <?php echo csrf_field(); ?>
                            ...
                            <div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-borderless align-middle mb-0">
                                        ...
                                        <tbody class="text-dark fw-medium" style="font-size: 14px;">
                                            <?php $__currentLoopData = $dboardPast; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr class="border-bottom text-center">
                                                <td><?php echo e($row->Date); ?></td>
                                                <td><?php echo e($row->Time); ?></td>
                                                <td><?php echo e($row->Doctor); ?></td>
...
</style><?php /**PATH C:\Users\HP\Documents\Visual Studio Projects\webdev_patient\resources\views/patient/dashboard.blade.php ENDPATH**/ ?>